...
<div>
    <div id="map" class="map" style="width: 100%; height: 900px; margin: 0px;"></div>
...
mapboxgl.accessToken = 'pk.eyJ1IjoidmljdG9yaW5vaSIsImEiOiJjbGtnbDgxbjYwMWxyM2VueTZzbzdjMG9xIn0.cDWO9uV_3oq2AlHuIWQzfw';
    ...
    const map = new mapboxgl.Map({
        ...
        center: [121.71827890300437, 16.950888694502364],
        pitch: 60,
        zoom: 14
        ...
        // pitch: 50,
        // // bearing: -60,
        // center: [153.1293449785665, -27.48326037749799],
        // zoom: 11
    });
